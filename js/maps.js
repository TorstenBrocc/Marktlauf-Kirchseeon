    ...
    const szIcon = L.divIcon({
      ...
      html: `
        <div style="position: relative; width: 72px; height: 72px;">
          <!-- Pin Background (scaled horizontally by 0.7 for narrower top) -->
          <div style="position: absolute; top: 11px; left: 11px; width: 50px; height: 50px; transform: scaleX(0.7); transform-origin: center center;">
            <div class="map-pin map-pin-sz" style="width: 100%; height: 100%; margin: 0;"></div>
          </div>
          <!-- SVG Symbol (centered over the fat part, rotated -15deg, sized 50x50) -->
          <div style="position: absolute; top: 0; left: 0; width: 72px; height: 72px; display: flex; justify-content: center; align-items: center;">
            <svg viewBox="16 37 180 184" style="width: 50px; height: 50px; transform: rotate(-15deg); margin: 0;">
