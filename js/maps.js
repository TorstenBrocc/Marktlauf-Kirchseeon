    ...
    const szIcon = L.divIcon({
      ...
      html: `
        <div style="position: relative; width: 72px; height: 72px;">
          <div class="map-pin map-pin-sz" style="position: absolute; top: 11px; left: 11px; width: 50px; height: 50px; margin: 0;">
            <svg viewBox="16 37 180 184" style="width: 45px; height: 45px; transform: rotate(15deg); margin: 0;">
