        ...
        <div class="container">
            <div class="footer-bottom">
                <p class="footer-legal">
                    ...
                    <a href="<?= $basePath ?>datenschutz.html" class="footer-link" data-i18n="footer.legal.privacy">Datenschutzerklärung</a>
                    <span class="footer-separator">|</span>
                    <a href="<?= $basePath ?>teilnahmebedingungen.html" class="footer-link" data-i18n="footer.legal.terms">Teilnahmebedingungen</a>
                </p>
