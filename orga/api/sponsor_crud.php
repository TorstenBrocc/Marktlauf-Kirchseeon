    ...
    switch ($action) {
        case 'create':
            ...
            $stmt->execute([
                ...
                'rechnung_betrag'        => trim($_POST['rechnung_betrag'] ?? '') !== '' ? (float) $_POST['rechnung_betrag'] : null,
